 ...
 * 条件过滤 Activity
 */
public class ConditionFilterAvtivity extends BaseActivity implements  CompoundButton.OnCheckedChangeListener,SelectTimePopup.OnConfirmTimeListener {
    ...
    public static Intent createIntent(Context context) {
        return new Intent(context, ConditionFilterAvtivity.class);
    }
