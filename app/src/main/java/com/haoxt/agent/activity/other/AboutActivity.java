...
import com.haoxt.agent.util.Constant;
...
import tft.mpos.library.util.DownloadUtil;
...
public class AboutActivity extends BaseActivity implements OnClickListener, OnLongClickListener, OnBottomDragListener {
	...
	public void initData() {
		...
		tvAboutAppInfo.setText(AppApplication.getInstance().getAppName()
				+ "\n" + AppApplication.getInstance().getAppVersion());
