...
import tft.mpos.library.R;
import tft.mpos.library.interfaces.AdapterCallBack;
import tft.mpos.library.interfaces.CacheCallBack;
import tft.mpos.library.interfaces.OnStopLoadListener;
...
public abstract class BaseRecyclerActivity<T, VH extends ViewHolder, A extends Adapter<VH>>
	...
	public void setAdapter(A adapter) {
		if (adapter instanceof BaseAdapter) {
			((tft.mpos.library.base.BaseAdapter) adapter).setOnItemClickListener(this);
			((tft.mpos.library.base.BaseAdapter) adapter).setOnItemLongClickListener(this);
		}
