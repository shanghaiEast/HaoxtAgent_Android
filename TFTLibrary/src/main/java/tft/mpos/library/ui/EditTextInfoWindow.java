...
import tft.mpos.library.base.BaseBottomWindow;
import tft.mpos.library.util.CommonUtil;
import tft.mpos.library.util.ContactUtil;
import tft.mpos.library.util.EditTextUtil;
...
public class EditTextInfoWindow extends BaseBottomWindow implements OnClickListener {
	...
	public static Intent createIntent(Context context, String key, String value) {
		return createIntent(context, key, value, "tft.mpos.library");
	}
	/**
	 * @param context
	 * @param key
	...
	public static Intent createIntent(Context context, int type, String key, String value) {
		return createIntent(context, type, key, value, "tft.mpos.library");
	}
	/**
	 * @param context
	 * @param type
